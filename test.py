...
username = ''
password = ''
connection = pymongo.MongoClient("mongodb://ip:port" )
db =connection.terrydb
coll=db.collection
doc={'a','b'}

db.book.insert({"nae": "Yama Guide", "auhor": "chesu"})
...
#    print(data['items'][0]['title']+'|'+data['items'][0]['description'])
#   print(data['items'][1]['title']+'|'+data['items'][1]['description'])
